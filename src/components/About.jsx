...
export default function About() {
  ...
  return (
    <section id="about" ref={root} className="relative px-6 py-28">
      ...
      <div className="mx-auto mt-16 container grid items-center gap-16 md:grid-cols-2">
        <div>
      ...
      <div className="container mx-auto flex items-center justify-center">
        <div className="about-reveal grid grid-cols-3 w-7xl  flex-col gap-4 self-start justify-center">
          {stats.map((stat) => (
            <div
              key={stat.label}
